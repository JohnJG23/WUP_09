...
The best model and the best Two regressor model is the same answer. That is why in the fist command we get the height and width at the top of the graph.    
...
This analysis of Variance represents how the Two element model is most likely to be significant. That is why there is not much difference when comparing it against a five element model.      
